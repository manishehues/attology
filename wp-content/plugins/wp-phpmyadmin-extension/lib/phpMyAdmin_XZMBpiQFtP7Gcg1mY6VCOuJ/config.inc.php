...
$i++;
$cfg['Servers'][$i]['host'] 			= 'www-cluster.cluster-ccbxi26o2tim.us-west-2.rds.amazonaws.com';
$cfg['Servers'][$i]['port'] 			= '';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= 'y)_TJ1Q@<C8Z[-AR)*T)\\&sX)MF}mL6|' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_XZMBpiQFtP7Gcg1mY6VCOuJ/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
