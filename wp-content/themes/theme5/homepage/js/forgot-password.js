...
function verify() {
  ...
  $.post( '/portal/reset',{email:email}, function( data ) {
    ...
    if(data.status == 200){
      ...
      $('#message').addClass('success-verification').text(`Please check your ${email} inbox to reset your password.`);
...
var modal = document.getElementById('verify-email-modal');

// Get the button that opens the modal
var btn = document.getElementById("forget-pwd-link");
